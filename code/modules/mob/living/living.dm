...
/mob/living/proc/do_bounce_anim_dir(direction, wait, var/strength=8, var/easein=0, var/easeout=0) //Easy is for easing
	var/pixel_x_diff = 0
	var/pixel_y_diff = 0
	...
	animate(pixel_x = old_pixel_x, pixel_y = old_pixel_y, time = wait, easing = easeout)
